    ...
    var body: some View {
        ...
        ZStack {
            ...
            RoundedRectangle(cornerRadius: cornerRadius, style: .continuous)
                ...
                .shadow(color: Color.black.opacity(0.1), radius: iconSize * 0.02, x: 0, y: iconSize * 0.01)
            ...
            GeometryReader { geo in
                ...
                .stroke(Color(nsColor: isDark ? .black : .white), style: StrokeStyle(lineWidth: w * 0.04, lineCap: .round, lineJoin: .round))
                ...
                .stroke(Color(nsColor: isDark ? .black : .white).opacity(isDark ? 0.5 : 0.4), style: StrokeStyle(lineWidth: w * 0.01, lineCap: .round))
            }
            .frame(width: iconSize, height: iconSize)
        }
